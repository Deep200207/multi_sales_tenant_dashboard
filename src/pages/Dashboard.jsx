      ...
      <div style={{ backgroundColor: 'white', padding: '20px' }}>
        <div>
          <div style={{ display: "flex", backgroundColor: "white" }}>
            ...
            <h3 style={{ float: 'right', width: '15%', }}>Org: {user?.tenant}</h3>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          <h3 style={{ textAlign: 'center', color: 'white' }}>Lead Data :- <Link to={"/leads"}
            style={{ color: 'black', backgroundColor: 'white', padding: '5px' }}>Leads Data</Link>
          </h3>
          <h3 style={{ textAlign: 'center', color: 'white', marginTop:'20px' }}>Call Logs Data:-<Link to={"/calls"}
            style={{ color: 'black', backgroundColor: 'white', padding: '5px' }}>Call Logs</Link>
          </h3>
        </div>
      </div>
    </>
